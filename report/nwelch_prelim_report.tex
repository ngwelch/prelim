...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{(\subref{fig:plants}) Plant locations (meters), infection status (black=infected) after 30 weeks, and sample data used to fit a model (blue); (\subref{fig:cum_infection}) number of infected plants at each inspection time. 
...
Figure (\ref{fig:full_field_sim}) repeats the unconditional simulations with all plants in the field. 
