...
```{r}
fullChain = fread(file="~/prelim/data/20k_25pct_aws_chain.csv")
results = fullChain[1e4:nrow(fullChain),]
accept_results = fread(file="~/prelim/data/20k_25pct_aws_metrics.csv")
