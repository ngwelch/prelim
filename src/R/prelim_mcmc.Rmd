...
figState = ggplot(data=dfTest, aes(x, y, color=factor(t6)), legend=FALSE) + 
  geom_point() + 
  scale_colour_manual(values = c("0"="grey", "1"="black"), guide=FALSE) +
  theme_bw() +
  theme(axis.line = element_line(colour='black'),
...
## Posterior Simulated Infections Per Week
```{r}
...
matplot(breakPoints[-1]-diff(breakPoints)/2, postSampleDensity, 
        ...
        xlab="week", ylab="density", ylim=c(0.2, 0.3))
dev.off()
```
...
colLabel = c('zeroTo19', 'twentyTo79', 'eightyTo99', 'knownInfection')
thecol = c("zeroTo19"="grey100", "twentyTo79"="grey75", 
           "eightyTo99"="grey50", "knownInfection"="black")
```
